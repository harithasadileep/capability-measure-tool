...
public interface CapabilityDAO {
	 ...
	 * @param searchDesc the search desc
	 * @return the maps
	 ...
	 * Archive map.
	 *
	 * @param mapEntity the map entity
	 ...
	 * Update cluster.
	 *
	 * @param clusterEntity the cluster entity
	 * @return true, if successful
	 * @throws Exception the exception
	 */
	 ...
	 *
	 * @param maturityDescEntity the maturity desc entity
	 * @return true, if successful
	 * @throws Exception the exception
	 */
	 ...
	 * @param meturityId the meturity id
	 ...
	 * @param sectorId the sector id
	 * @param capabilityId the capability id
	 * @param strategicChoiceId the strategic choice id
	 * @param versionId the version id
	 ...
	 *
	 * @param overlayXrefEntity the overlay xref entity
	 * @return true, if successful
	 * @throws Exception the exception
	 */
