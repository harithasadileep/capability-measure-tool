 ...
 */
@Embeddable
public class StrategicChoicePK implements Serializable {
	...
	/**
	 * Instantiates a new strategic choice pk.
	 */
	public StrategicChoicePK() {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof StrategicChoicePK)) {
			return false;
		}
		StrategicChoicePK castOther = (StrategicChoicePK)other;
		return 
